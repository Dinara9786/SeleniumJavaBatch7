...
public class ElementCommands {
	...
	public static String url = "http://166.62.36.207/syntaxpractice/basic-radiobutton-demo.html"; // we CAN STORE outside the main method 
...
//		WebElement ageRadioBtn = driver.findElement(By.xpath("//input[@value = '0-5']")); // whenever we get a title, it returns a webelement
//								// WebElement is interface // ageRadioBtn is 0-5		
		...
		// I check 2 conditions:  i want to check if a particular element is enabled and is displayed
		...
		// we are checking is ageRadioBtn is selected
