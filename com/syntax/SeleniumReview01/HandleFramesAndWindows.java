...
public class HandleFramesAndWindows extends CommonMethods {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// We have 3 overloaded methods to take selenium's attention to iframe
		...
		// If we want to work on an element on main frame we have to take selenium's attention to main frame
		
		driver.switchTo().defaultContent(); // --> very important
		
		// if we want to work on another iframe
		// 1. we need to go back to default content
		// 2. switch to the next iframe
		
		// how to handle windows
		// getHandles() method -- > Set of String of the window handles of the all pages
		...
		System.out.println("Main Handle: " + childWindowHandle);
		
		//take seleinium's attention to child window
...
//		
//		driver.findElement(By.id("\"google_ads_iframe_/21783347309/espn.com/frontpage/index_3\"")).click();
