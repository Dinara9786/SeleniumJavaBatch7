...
public static String url = "http://166.62.36.207/humanresources/symfony/web/index.php/auth/login";
	...
	public static void main(String[] args) throws InterruptedException  {
		...
		employeeList.click();
		WebElement sortByName = driver.findElement(By.partialLinkText("//a[contains.text(), 'First')]"));
		...
		while (flag) {
			...
			for(int i=0; i<rows.size(); i++) {
				...
				if (rowText.contains(empId)) {
					flag = false;
					WebElement checkBox = driver.findElement(By.xpath("//table[@id = 'resultTable']/tdoby/tr["+ i +"]/td[1]"));
					// getting I from iteration and locating only the checkbox
					checkBox.click();
